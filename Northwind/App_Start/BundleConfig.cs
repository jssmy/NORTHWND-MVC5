...
namespace Northwind
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Utilice la versión detoastjs desarrollo de Modernizr para desarrollar y obtener información. De este modo, estará
            ...
            bundles.Add(new StyleBundle("~/Content/sweetalert/alert").Include(
